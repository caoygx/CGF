...
namespace Cgf\Template\Thinkphp;

use Cgf\Definition;
use Cgf\Template;
use Cgf\Cgf;
use think\Exception;
use Cgf\Template\Bootstrap\Bootstrap;
...
//================================= 列表 start ===========================================
    ...
    function generateListsTemplate()
    {
        ...
        $templateDir = __DIR__;
        $file        = $templateDir . "/" . $this->dirForm . "/tpl_list.html";
        if (!file_exists($file)) {
...
//================================= 添加 start ===========================================
    function generateAddTemplate($isEdit = false)
    {
        ...
        $templateDir = __DIR__;
        $file        = $templateDir . "/" . $this->dirForm . "/tpl_add.html";
        if (!file_exists($file)) {
