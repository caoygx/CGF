...
function view(id) {
    ...
    //location.href = URL + "/show/id/" + keyValue;
	domain = "rrbrr.com";
	subdomain = "www.";
	location.href = "http://"+subdomain+domain +URL+ "/show/id/" + keyValue;
